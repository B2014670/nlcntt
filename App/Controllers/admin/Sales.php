    ...
    class Sales extends Controller{
        ...
        function update($id){
            if(isset($_POST)){
                ...
                if ($result == true) header("Location: ".DOCUMENT_ROOT."/admin/sales");
                else {                    
                    header("Location: ".DOCUMENT_ROOT."/admin/sales/edit/".$data["id"]);
                    echo '<script>alert("Chưa có thay đỗi!!")</script>'; 
                } 
            }
