<?php
    ...
    class Originals extends Controller{
        private $origModel;
        ...
        function store(){
            if(!isset($_POST)){
                ...
                if ($result == true) 
                    header("Location: ".DOCUMENT_ROOT."/admin/original");
                else 
                    header("Location: ".DOCUMENT_ROOT."/admin/original/create");
            }
        }
        ...
        function update($origId){
            if(!isset($_POST)){
                ...
                if ($result == true) 
                    ...
                    header("Location: ".DOCUMENT_ROOT."/admin/original/edit");
            }
        }
        function delete(){
            if(isset($_GET)){
